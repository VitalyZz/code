...
export default {
  ...
  methods: {
    ...
    async answerHandler(answer) {
      ...
      if (this.words[this.index].temporal_number_correct >= 5) {
        this.words[this.index].temporal_number_correct = 0;
        this.words[this.index].meaning = "0";
      }
      ...
      const data = {
        ...
        meaning: this.words[this.index].meaning
      };

      console.log('answerHandler DATA word update', data);
    ...
    async matchHandler(bool, element) {
      ...
      if (curWord.temporal_number_correct >= 5) {
        curWord.temporal_number_correct = 0;
        curWord.meaning = "0";
      }
      ...
      const data = {
        ...
        meaning: curWord.meaning
      };

      console.log('matchHandler DATA word update', data);
